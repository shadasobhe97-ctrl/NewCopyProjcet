              ...
              if (state is ChatListLoaded) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSubActive = item.subscriptionStatus.toLowerCase() == 'active';
                            ...
                            children: [
                              ...
                              ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: item.otherUserPhoto != null && item.otherUserPhoto!.isNotEmpty
                                      ? CachedNetworkImage(
                                          imageUrl: item.otherUserPhoto!,
                                          fit: BoxFit.cover,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (item.otherUserPhone != null && item.otherUserPhone!.isNotEmpty) ...[
                                      SizedBox(height: 4.h),
                                      Text(
                                        item.otherUserPhone!,
                                        style: AppTextStyles.style(
                              ...
                              Container(
                                ...
                                child: Text(
                                  isSubActive ? 'اشتراك نشط' : 'اشتراك منتهي',
                                  style: AppTextStyles.style(
                                    fontSize: 10.sp,
                                    fontWeight: FontWeight.bold,
