    ...
    return const TripDetailsModel(
      ...
      timeline: [
        TripTimelineItemModel(
          ...
          title: 'بدأت الرحلة',
          time: '07:00 ص',
          description: 'انطلق السائق محمود من محطة البداية',
          isDone: true,
        ),
        TripTimelineItemModel(
          status: 'boarded',
          title: 'تم صعود سارة الحافلة',
          time: '07:15 ص',
          description: 'تم توثيق صعود سارة بنجاح',
          isDone: true,
        ),
        TripTimelineItemModel(
          status: 'in_transit',
          title: 'الحافلة في الطريق إلى المدرسة',
          time: '07:20 ص',
          description: 'تسير الحافلة على الطريق السريع',
          isDone: false,
          isCurrent: true,
        ),
        TripTimelineItemModel(
          ...
          time: '07:45 ص',
          description: 'الوصول المتوقع بسلامة الله',
          isDone: false,
        ),
      ],
    );
