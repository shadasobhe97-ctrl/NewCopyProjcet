...
// =============================================================================
// نموذج طلب الاشتراك الموحد للسائق - DriverRequestModel
// يمثل طلباً موحداً على مستوى طلب ولي الأمر ككل يحتوي جميع الأطفال
// =============================================================================
...
class DriverRequestModel {
  ...
  /// ترجمة حالة الطلب المعتمدة بالعربية
  ...
  /// السعر الإجمالي للعرض المباشر
  String get totalPriceDisplay => pricing?.formattedTotal ?? '0 د.ل';

  /// صافي أرباح السائق للعرض المباشر
  String get driverNetTotalDisplay => pricing?.formattedDriverNet ?? '0 د.ل';
  ...
  factory DriverRequestModel.fromJson(Map<String, dynamic> json) {
    ...
    final pricingJson = json['pricing'] is Map
        ...
        : (json['total_price'] != null || json['total_amount'] != null
            ? <String, dynamic>{
                'total_price': json['total_price'] ?? json['total_amount'],
                'discount_amount': json['discount_amount'],
                'total_amount_after_discount': json['total_after_discount'] ?? json['total_amount_after_discount'],
                'platform_commission_total': json['platform_commission_total'],
                'driver_net_total': json['driver_net_total'],
              }
            : null);
    ...
    String readStatus = 'pending';
    String? readStatusLabel = json['status_label']?.toString();
    if (json['status'] is Map) {
      readStatus = (json['status'] as Map)['value']?.toString() ?? 'pending';
